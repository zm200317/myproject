  ...
  <div>
    ...
    <div style="margin-bottom: 25px;margin-top: 80px">
      <el-breadcrumb separator-class="el-icon-arrow-right">
        ...
        <el-breadcrumb-item><span style="color: #d43c33">高分五号</span></el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    <el-row :gutter="20">
      <el-col :span="6" v-for="(item,key) in imgList"  :key="key">
        <div class="grid-content bg-purple">
          <router-link to="/dataresource/satallite">
            <img class="detail-img" :src="item.imgPath" @click="getSatelliteID('GF5')">
          </router-link>
          <div class="pText">
...
export default {
  ...
  methods: {
    ...
    getSatelliteID (value) {
      ...
      sessionStorage.setItem('SatelliteID', 'GF5')
    },
    // 获取指定卫星ID的数据大小
    getDataSize (value) {
  ...
  mounted () {
    this.getDataSize('GF5')
    this.getSatelliteID('GF5')
  },
  data () {
    return {
      imgList: [
