<template>
  <div>
    <div class="block" style="margin-top: 80px;width: 720px;float: left">
      <div style="margin-bottom: 25px">
        <el-breadcrumb separator-class="el-icon-arrow-right">
          ...
          <el-breadcrumb-item v-show="SatelliteID==='GF5'"><span style="color: #d43c33">高分五号</span></el-breadcrumb-item>
          <el-breadcrumb-item v-show="SatelliteID==='ZY1E'"><span style="color: #d43c33">资源一号</span></el-breadcrumb-item>
          <el-breadcrumb-item v-show="SatelliteID==='HJ2A'"><span style="color: #d43c33">环境2A号</span></el-breadcrumb-item>
          <el-breadcrumb-item v-show="SatelliteID==='HJ2B'"><span style="color: #d43c33">环境2B号</span></el-breadcrumb-item>
        </el-breadcrumb>
      </div>
      <el-pagination
        background
    ...
    <div style="float: left;margin-top: 40px">
      <el-button @click="collects()" type="primary">批量收藏</el-button>
    </div>
    <div style="margin-top:100px;float: right;width: 500px">
      <el-input placeholder="请输入内容" v-model="value" class="input-with-select" @change="satellites()" style="float: right;width: 200px">
        <el-button type="primary" slot="append" icon="el-icon-search"></el-button>
      </el-input>
      <el-select v-model="select" slot="prepend" placeholder="请选择" style="width:100px;float: right">
