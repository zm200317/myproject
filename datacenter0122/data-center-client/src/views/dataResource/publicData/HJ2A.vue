  ...
  <div>
    ...
    <div style="margin-bottom: 25px;margin-top: 80px">
      <el-breadcrumb separator-class="el-icon-arrow-right">
        ...
        <el-breadcrumb-item><span style="color: #d43c33">环境2A号</span></el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    <el-row :gutter="20">
...
export default {
  name: 'HJ2A',
  mounted () {
    this.getSatelliteID('HJ2A')
    this.getDataSize('HJ2A')
  },
  methods: {
    myClick () {
    ...
    getSatelliteID (value) {
      ...
      sessionStorage.setItem('SatelliteID', 'HJ2A')
    },
    // 获取指定卫星ID的数据大小
    getDataSize (value) {
