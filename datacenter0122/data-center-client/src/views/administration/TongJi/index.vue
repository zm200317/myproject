          ...
          <el-row>
            <el-col :span="12">
              <div class="grid-content">
                <div class="icons">
                  <i class="iconfont icon-user" style="margin-top: 3px"></i>
            ...
            <el-col :span="12">
              <div class="grid-content">
                <ul class="icons-right">
                  ...
                  <li>
                    <countTo :startVal="user.startVal" :endVal="userNumb" :duration="1"></countTo>
                  </li>
                </ul>
              </div>
            </el-col>
...
<!--                <img src="../../assets/img/tou.jpg">-->
              ...
              <li class="time">当前时间：</li>
              <li class="time">上次登陆：</li>
            </ul>
          </div>
        </div>
      </el-col>
...
export default {
  ...
  mounted () {
    this.drawChart()
    this.init()
    reqUserNumb().then(response => {
      this.userNumb = response.data
    })
  },
  destroyed () {
  ...
  methods: {
    ...
    drawChart () {
      ...
      let option = {
        ...
        xAxis: {
          type: 'category',
          data: ['01-02', '01-03', '01-03', '01-04', '01-05', '01-06', '01-07']
        },
        yAxis: {
          type: 'value'
        },
    ...
    toDo (item, i) {
      this.$set(this.todulist[i], 'checked', !item.checked)
    }
  }
}
</script>
